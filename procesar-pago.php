...
//
// Sustituye al Worker de Cloudflare (api-pagos.a-cembrero.workers.dev)
// al que no se tiene acceso. Las credenciales de Redsys de aquí abajo
// son las mismas que ya usaba la integración original (verificadas:
// coinciden con la pantalla real de pago — Terminal 369618186-1).
// ═══════════════════════════════════════════════════════════════
